...
public class MainMenu {
    ...
    // grid[][] is a parallel array to buttonGrid[][] whose values depend on the button background
    int[][] grid = new int[gridSize][gridSize];
    
    // Declaration of class objects to call their constructors from within an ActionListener
    StartGame game;

    /**
     * MainMenu() is the constructor of the MainMenu class. It is ran once an instance of the class
    ...
    /**
     * createStartGame() calls the costructor of the StartGame class from the same class instance.
     * The keyword "this" refers to the Main Menu containing this exact StartGame game variable.
     */
